...
class ProjectionService:
    def create_single_projection(self, coords: CubeCoords, plane: Plane = Plane.XY) -> str:
    ...
    def create_multiple_projection(self, coord_list: List[CubeCoords], plane: Plane = Plane.XY) -> List[str]:
        converter = CoordsConverter()
        polygons = [Polygon(converter.get_cube_points_from_coords(coords, plane)) for coords in coord_list]
